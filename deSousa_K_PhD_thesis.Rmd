...
kable(tb,
      booktabs = TRUE,
      align = "cccccc",
      caption = "Number of tricot trials per cropping season of durum wheat (Ethiopia, Meher season), bread wheat (India, Rabi season), and common bean (Nicaragua).") %>%
...
```{r cocoa_replace, fig.cap = "Potential areas where cocoa (\\emph{Theobroma cacao} L.) could replace coffee (\\emph{Coffea arabica} L.) under climate change. Dark blue indicate vulnerable areas for coffee that can be replaced by cocoa. Light blue indicate areas suitable for coffee and cocoa. Red indicate vulnerable areas for coffee where cocoa is not an alternative under climate change. Light yellow indicate remaining areas for coffee where cocoa is not suitable.", echo=FALSE, out.width = '70%', fig.align="center"}
...
This thesis would be likely impossible without the contribution of a number of people, to be exact, 34 co-authors who contributed in some extent to the development of this work. Thanks to the more than 10,000 farmers citizen scientists who evaluated varieties in Nicaragua, Ethiopia, and India. They made it possible for me to develop a significant part of this thesis. I really appreciate all the contribution. Thanks to Elias de Melo Virginio Filho and Ronnie De Camino for opening the doors for my career in international agricultural research. One special thanks to Jenny Ordoñez, Maarten van Zonneveld, Milena Holmgren, Leida Mercado and Fernando Casanoves who guided me in the first steps that I took towards this project. Your support, advice, encouragement, and brilliant insights are something that I will keep with me for the rest of my life. Thank you!

Thanks to Svein Ø. Solberg for being such an amazing supervisor, proving great support and always great advices that made possible for me to develop this work. Thanks to my co-supervisor, Jacob van Etten, for his brilliant ideas that inspired me during these years. Thanks to Fred H. Johnsen for his great support in my arrival to Norway and the early steps of my PhD project. Thanks to Matteo Dell'Acqua and Mario Enrico Pè for being such a nice hosts during my research stay at the Scuola Superiore Sant'Anna in Italy. Thanks to Øyvind Antonsen and the Department of Biotechnology for hosting me at *Biohus* during a significant part of this project. Thanks to Isolde D. K. Ferraz and Geângelo P. Calvi for the excellent research stay at the National Institute of Amazonian Research (INPA) in Brazil. Thanks to Magne Neby for the nice discussions while we shared the office in Blæstad, the logistic support in moving from Ottestad to Hamar, and the help in editing this thesis. Thanks to Eliana Bontti for all the advices and nice talks that helped me a lot. Thanks to Olivier Devineau for being always supportive in giving statistical advice. Thanks to Henriette Wathne Gelink, Kaja Johnsen, Sarah Louise Loftheim, Elisabeth Røe, Morten Tofastrud, Lucy Walmsnæss, Maria Hörnell Willebrand and Ragnhild Østerhagen for the administrative support and advice. Also thanks to my Department colleagues Thomas Cottis, Hans Christian Endrerud, Dag Jørgensen, Marius Kjønsberg, Stein Amundsen Morthov, Terje Motrøen, Jill Peng and Lars Erik Ruud for all the support and companionship. Thanks to Nora Castañeda-Álvarez for the inputs and comments during the mid-term evaluation that helped in the improvement of this thesis. Thanks to the International Research School in Applied Ecology (IRSAE) for providing learning and networking opportunities via the Summer Schools, Climate Change Group and Courses.
...
\normalsize Farmer evaluating a common bean plot under the *tricot* approach, Honduras. Credit: J. Steinke
