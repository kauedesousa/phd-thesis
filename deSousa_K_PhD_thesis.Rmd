...
This assessment focussed on Central America as a whole region, within the coordinates 101, 77 E, and 7, 22 N. We wanted to answer two main questions, (*i*) how ecologically resilient are the trees commonly used by farmers in coffee and cocoa agroforestry systems?, (*ii*) can cocoa become a potential suitable alternative for coffee growers?. These questions came out as a result from the assessment on farmers' adaptation decisions described in the earlier section. Among all the other adaptation decisions, restoration and reforestation (using agroforestry) were the most preferred by the interviewed farmers [@deSousa2018]. 
