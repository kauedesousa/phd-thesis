...
The results demonstrated the ability of the model with climatic covariates in capture the environmental variability of the sampled environments. This means that the climatic covariates contain unique and substantial information explaining varietal performance. For Nicaragua, we found that common bean variety performance changed when the maximum night temperature exceeded 18.7 $^\circ C$. This finding corresponds to the threshold temperature for heat stress reported in the literature of 20 $^\circ C$ at night [@Rainey2005].
