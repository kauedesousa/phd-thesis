...
```{r cocoa_replace, fig.cap = "Potential areas where cocoa (\\emph{Theobroma cacao} L.) can replace coffee (\\emph{Coffea arabica} L.) under climate change.", echo=FALSE, out.width = '60%', fig.align="center"}
knitr::include_graphics("display-items/cocoa_replace_coffee.png")
```


* The impacts could be lower than we expect [@DaMatta2019]
* Robusta seemed an alternative but is also vulnerable [@Kath2020]
* Ecological issues in expanding to higher elevations
